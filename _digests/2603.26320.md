...
$$p\_t(x\_i | x\_i^1) = \text{softmax}(-\beta\_t \cdot d(x\_i, x\_i^1))$$
...
$$u\_t(x\_i, z | x^1) = p\_t(x\_i | x\_i^1) \cdot \dot{\beta}\_t \cdot [d(z\_i, x\_i^1) - d(x\_i, x\_i^1)]\_+$$
...
$$\mathcal{L}\_{\text{CE}} = \mathbb{E}\_{t \sim \mathcal{U}(0,1),\, x^1,\, x^t} \left[ -\log p\_{1|t}(x^1 | x\_t, l) \right]$$
